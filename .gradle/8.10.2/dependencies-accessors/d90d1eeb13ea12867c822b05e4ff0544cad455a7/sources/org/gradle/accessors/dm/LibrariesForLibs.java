...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>appcompat.version</b>
     * <p>
     ...
     * with version reference <b>biometric.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
     ...
     * with version reference <b>constraintlayout.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
     ...
     * with version reference <b>lottie.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
     ...
     * with version reference <b>material.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final BiometricVersionAccessors vaccForBiometricVersionAccessors = new BiometricVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.appcompat</b>
         */
        public AppcompatVersionAccessors getAppcompat() {
            return vaccForAppcompatVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.biometric</b>
         */
        public BiometricVersionAccessors getBiometric() {
            return vaccForBiometricVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.lottie</b>
         */
    ...
    public static class AppcompatVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>appcompat.version</b> with value <b>1.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BiometricVersionAccessors extends VersionFactory  {

        public BiometricVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>biometric.version</b> with value <b>1.2.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("biometric.version"); }
    ...
    public static class ConstraintlayoutVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>constraintlayout.version</b> with value <b>2.1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("constraintlayout.version"); }
    ...
    public static class LottieVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lottie.version</b> with value <b>6.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("lottie.version"); }
    ...
    public static class MaterialVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material.version</b> with value <b>1.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
